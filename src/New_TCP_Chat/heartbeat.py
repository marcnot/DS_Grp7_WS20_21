...
class Heartbeat:
    def __init__(self, hosts, election, socket_sender):
        ...
        self.own_address = host_address
        self.last_heartbeat_received = time.time()
        self.last_heartbeat_sent = (time.time() - heartbeat_intervall)  # substract 3 sec. so that first heartbeat is sent immediately
    ...
    def send_heartbeat(self):
        ...
        if time_diff >= heartbeat_intervall:
    ...
    def handle_heartbeat_message(self, addr, parts):
        ...
        if self.election.isLeader is False:
            ...
            if addr[0] == right_neighbour:
                ...
                print("Heartbeat: received from wrong neighbour")
        else:
